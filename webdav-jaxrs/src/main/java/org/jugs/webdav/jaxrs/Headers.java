 ...
 * %%
 * Copyright (C) 2008 - 2026 Java User Group Stuttgart
 * %%
 ...
 * 
 * @see <a href="http://www.webdav.org/specs/rfc4918.html#http.headers.for.distributed.authoring">Chapter 10 "HTTP Headers for Distributed Authoring" of RFC
...
public interface Headers {
	 ...
	 * WebDAV Depth Header
	 * 
	 * @see <a href="http://www.webdav.org/specs/rfc4918.html#HEADER_Depth">Chapter 10.2 "Depth Header" of RFC 4918
	 *      "HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)"</a>
	 */
	 ...
	 * 
	 * @see <a href="http://www.webdav.org/specs/rfc4918.html#HEADER_Destination">Chapter 10.3 "Destination Header" of RFC 4918
	 *      "HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)"</a>
	 */
	 ...
	 * WebDAV If Header
	 * 
	 * @see <a href="http://www.webdav.org/specs/rfc4918.html#HEADER_If">Chapter 10.4 "If Header" of RFC 4918
	 *      "HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)"</a>
	 */
	 ...
	 * 
	 * @see <a href="http://www.webdav.org/specs/rfc4918.html#HEADER_Lock-Token">Chapter 10.5 "Lock-Token Header" of RFC 4918
	 *      "HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)"</a>
	 */
	 ...
	 * 
	 * @see <a href="http://www.webdav.org/specs/rfc4918.html#HEADER_Overwrite">Chapter 10.6 "Overwrite Header" of RFC 4918
	 *      "HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)"</a>
	 */
	 ...
	 * 
	 * @see <a href="http://www.webdav.org/specs/rfc4918.html#HEADER_Timeout">Chapter 10.7 "Timeout Request Header" of RFC 4918
	 *      "HTTP Extensions for Web Distributed Authoring and Versioning (WebDAV)"</a>
	 */
